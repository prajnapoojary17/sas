            ...
            <div class="col-lg-12">
                <div class="portlet box yellow">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-list-ul"></i> User Count Reports
                        </div>
                        <div class="tools">
                            <div class="date-display">
                                <i class="icon-calendar"></i>
                    ...
                    <div class="portlet-body">
                        <div class="table-responsive custom_datatable">
                            ...
                            <form class="form-horizontal form-striped" action="<?php echo base_url(); ?>generatereport/countReport" method="get" name="report" id="report">                          
                                    ...
                                    if (isset($records) && count($records) > 0) {
                                        ...
                                        foreach ($records as $records_obj) {
                                            ...
                                            <tr>                                                 
                                                ...
                                                <td><?php echo $records_obj['login_date']; ?></td>
                                                <td><?php echo $records_obj['UPICount']; ?></td> 
                                                <td><?php echo $records_obj['SASCount']; ?></td>
                                                <td><?php echo $records_obj['ChallanCount']; ?></td>
                                            </tr>
                                            <?php
